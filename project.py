...
def state_title_to_settings() -> int:
  game_state["title_screen"] = False
  game_state["title_settings"] = True
  return 0


def state_settings_to_title() -> int:
  game_state["title_settings"] = False
  game_state["title_screen"] = True
  return 0


def state_title_to_gameplay() -> int:
  game_state["title_screen"] = False
  game_state["gameplay"] = True
  return 0


def state_gameplay_to_title() -> int:
  game_state["gameplay"] = False
  game_state["title_screen"] = True
  return 0


def state_gameplay_to_game_over() -> int:
  game_state["gameplay"] = False
  game_state["game_over"] = True
  return 0


def state_game_over_to_gameplay() -> int:
...
def state_game_over_to_title() -> int:
  game_state["game_over"] = False
  game_state["title_screen"] = True
  ship.pos = Vector2(
    (GAME_WIDTH / 2) - (ship.texture.width / 2),
